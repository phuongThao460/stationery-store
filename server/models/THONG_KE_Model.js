...
export const Compute_Tong_Tien_By_Don_Hangs = don_hangs => {
	...
	*/
	...
	return [tong_tien_san_pham_ban_duoc, tong_tien_giam_boi_voucher,
			tong_doanh_thu]
}
	...
	*/
	...
	try {
		var rs = await CT_DON_HANG_Model.aggregate([
			...
			{ $project: { san_pham: { $arrayElemAt: ["$san_pham", 0] },
						  gia_ban: 1,
						  so_luong: 1,
						  tong_gia: 1,
						  mau_sac: 1,
...
export const Compute_Tong_Tien_By_CT_Thong_Kes = (ct_thong_kes, thong_ke) => {
	...
	*/
	...
	for (var ct_thong_ke of ct_thong_kes) {
		tong_gia_nhap += (ct_thong_ke._id.gia_nhap * ct_thong_ke.tong_so_luong_da_ban)
	}

	// Compute tong_doanh_thu
	tong_doanh_thu = thong_ke.tong_tien_san_pham_ban_duoc - thong_ke.tong_tien_giam_boi_voucher
